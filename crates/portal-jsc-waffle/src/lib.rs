...
use portal_pc_waffle::{
    BlockTarget, Func, FunctionBody, Module, Operator, Signature, SignatureData, StorageType, Type,
    WithMutablility, WithNullable,
};
...
impl Tries {
    fn get(&mut self, module: &mut Module, val: Type) -> Signature {
    ...
    fn get_getter(&mut self, module: &mut Module, val: Type) -> Func {
    ...
    fn get_setter(&mut self, module: &mut Module, val: Type) -> Func {
